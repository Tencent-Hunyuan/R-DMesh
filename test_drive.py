...
if __name__ == '__main__':
    ...
    parser.add_argument("--video_data_dir", type=str, default="./all_glbs")
    ...
    parser.add_argument("--rf_model_dir", type=str, default="./rf_ckpts")
    parser.add_argument("--wan_model_dir", type=str, default="./Wan2.2-TI2V-5B")
    ...
    parser.add_argument("--mode", type=str, default="tc", choices=["tc", "vc", "vc_flext"])
